 ...
 */
@Entity
@Table(name = "GA_ABOCEL")
public class AbocelGA implements Serializable {
    ...
    public int hashCode() {
        int hash = 3;
        hash = 41 * hash + (int) (this.suscriberId ^ (this.suscriberId >>> 32));
        hash = 41 * hash + (int) (this.phoneNumber ^ (this.phoneNumber >>> 32));
        hash = 41 * hash + Objects.hashCode(this.situationCode);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final AbocelGA other = (AbocelGA) obj;
        ...
        if (!Objects.equals(this.situationCode, other.situationCode)) {
            return false;
        }
        return true;
    }
